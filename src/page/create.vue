  ...
  <div class="create">
    ...
    <div class="create-put">
      <div class="l-put">
        ...
        <input type="text" placeholder="请输入群名" v-model="crowd" />
      </div>
    </div>
    <div class="c-center">
    ...
    <div class="toast" v-show="show">请先输入群名</div>
    <div class="toast" v-show="mask">群名已存在</div>
    <div class="toast" v-show="busy">网络繁忙，请稍后尝试</div>
  </div>
</template>
<script>
